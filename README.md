...
An open-source wearable platform for health monitoring, security tooling, and embedded AI — built on the Waveshare ESP32-S3-Touch-LCD-1.46.
Hardware  →  Waveshare ESP32-S3 · MAX30102 (SpO₂/HR) · BME280 (env) · 1.46" round LCD
Firmware  →  PlatformIO · Arduino + FreeRTOS · LovyanGFX · LVGL 8.x
Case      →  OpenSCAD parametric · ~50.4mm OD · 19.4mm total height (v1.5)


📦 Other Work

go-teleg
Lightweight Go library for the Telegram Bot API

Dwindle-bot
Telegram bot framework experiment
